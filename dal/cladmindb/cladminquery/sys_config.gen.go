...
func newSysConfig(db *gorm.DB, opts ...gen.DOOption) sysConfig {
	...
	_sysConfig.sysConfigDo.UseModel(&cladminmodel.SysConfig{})

	tableName := _sysConfig.sysConfigDo.TableName()
	_sysConfig.ALL = field.NewAsterisk(tableName)
	_sysConfig.ID = field.NewUint64(tableName, "id")
...
type ISysConfigDo interface {
	...
	Create(values ...*cladminmodel.SysConfig) error
	CreateInBatches(values []*cladminmodel.SysConfig, batchSize int) error
	Save(values ...*cladminmodel.SysConfig) error
	First() (*cladminmodel.SysConfig, error)
	Take() (*cladminmodel.SysConfig, error)
	Last() (*cladminmodel.SysConfig, error)
	Find() ([]*cladminmodel.SysConfig, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysConfig, err error)
	FindInBatches(result *[]*cladminmodel.SysConfig, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*cladminmodel.SysConfig) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*cladminmodel.SysConfig, error)
	FirstOrCreate() (*cladminmodel.SysConfig, error)
	FindByPage(offset int, limit int) (result []*cladminmodel.SysConfig, count int64, err error)
...
func (s sysConfigDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ISysConfigDo {
...
func (s sysConfigDo) Create(values ...*cladminmodel.SysConfig) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysConfigDo) CreateInBatches(values []*cladminmodel.SysConfig, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysConfigDo) Save(values ...*cladminmodel.SysConfig) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysConfigDo) First() (*cladminmodel.SysConfig, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*cladminmodel.SysConfig), nil
	}
}

func (s sysConfigDo) Take() (*cladminmodel.SysConfig, error) {
...
func (s sysConfigDo) Last() (*cladminmodel.SysConfig, error) {
...
func (s sysConfigDo) Find() ([]*cladminmodel.SysConfig, error) {
	result, err := s.DO.Find()
	return result.([]*cladminmodel.SysConfig), err
}

func (s sysConfigDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysConfig, err error) {
	buf := make([]*cladminmodel.SysConfig, 0, batchSize)
...
func (s sysConfigDo) FindInBatches(result *[]*cladminmodel.SysConfig, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysConfigDo) FirstOrInit() (*cladminmodel.SysConfig, error) {
...
func (s sysConfigDo) FirstOrCreate() (*cladminmodel.SysConfig, error) {
...
func (s sysConfigDo) FindByPage(offset int, limit int) (result []*cladminmodel.SysConfig, count int64, err error) {
...
func (s sysConfigDo) Delete(models ...*cladminmodel.SysConfig) (result gen.ResultInfo, err error) {
