...
func newSysRoleMenu(db *gorm.DB, opts ...gen.DOOption) sysRoleMenu {
	...
	_sysRoleMenu.sysRoleMenuDo.UseModel(&cladminmodel.SysRoleMenu{})
...
type ISysRoleMenuDo interface {
	...
	Create(values ...*cladminmodel.SysRoleMenu) error
	CreateInBatches(values []*cladminmodel.SysRoleMenu, batchSize int) error
	Save(values ...*cladminmodel.SysRoleMenu) error
	First() (*cladminmodel.SysRoleMenu, error)
	Take() (*cladminmodel.SysRoleMenu, error)
	Last() (*cladminmodel.SysRoleMenu, error)
	Find() ([]*cladminmodel.SysRoleMenu, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysRoleMenu, err error)
	FindInBatches(result *[]*cladminmodel.SysRoleMenu, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*cladminmodel.SysRoleMenu) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*cladminmodel.SysRoleMenu, error)
	FirstOrCreate() (*cladminmodel.SysRoleMenu, error)
	FindByPage(offset int, limit int) (result []*cladminmodel.SysRoleMenu, count int64, err error)
...
func (s sysRoleMenuDo) Create(values ...*cladminmodel.SysRoleMenu) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleMenuDo) CreateInBatches(values []*cladminmodel.SysRoleMenu, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysRoleMenuDo) Save(values ...*cladminmodel.SysRoleMenu) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysRoleMenuDo) First() (*cladminmodel.SysRoleMenu, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*cladminmodel.SysRoleMenu), nil
	}
}

func (s sysRoleMenuDo) Take() (*cladminmodel.SysRoleMenu, error) {
...
func (s sysRoleMenuDo) Last() (*cladminmodel.SysRoleMenu, error) {
...
func (s sysRoleMenuDo) Find() ([]*cladminmodel.SysRoleMenu, error) {
	result, err := s.DO.Find()
	return result.([]*cladminmodel.SysRoleMenu), err
}

func (s sysRoleMenuDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysRoleMenu, err error) {
	buf := make([]*cladminmodel.SysRoleMenu, 0, batchSize)
...
func (s sysRoleMenuDo) FindInBatches(result *[]*cladminmodel.SysRoleMenu, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysRoleMenuDo) FirstOrInit() (*cladminmodel.SysRoleMenu, error) {
...
func (s sysRoleMenuDo) FirstOrCreate() (*cladminmodel.SysRoleMenu, error) {
...
func (s sysRoleMenuDo) FindByPage(offset int, limit int) (result []*cladminmodel.SysRoleMenu, count int64, err error) {
...
func (s sysRoleMenuDo) Delete(models ...*cladminmodel.SysRoleMenu) (result gen.ResultInfo, err error) {
