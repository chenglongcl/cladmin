...
func newSysUserRole(db *gorm.DB, opts ...gen.DOOption) sysUserRole {
	...
	_sysUserRole.sysUserRoleDo.UseModel(&cladminmodel.SysUserRole{})
...
type ISysUserRoleDo interface {
	...
	Create(values ...*cladminmodel.SysUserRole) error
	CreateInBatches(values []*cladminmodel.SysUserRole, batchSize int) error
	Save(values ...*cladminmodel.SysUserRole) error
	First() (*cladminmodel.SysUserRole, error)
	Take() (*cladminmodel.SysUserRole, error)
	Last() (*cladminmodel.SysUserRole, error)
	Find() ([]*cladminmodel.SysUserRole, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysUserRole, err error)
	FindInBatches(result *[]*cladminmodel.SysUserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*cladminmodel.SysUserRole) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*cladminmodel.SysUserRole, error)
	FirstOrCreate() (*cladminmodel.SysUserRole, error)
	FindByPage(offset int, limit int) (result []*cladminmodel.SysUserRole, count int64, err error)
...
func (s sysUserRoleDo) Create(values ...*cladminmodel.SysUserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserRoleDo) CreateInBatches(values []*cladminmodel.SysUserRole, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s sysUserRoleDo) Save(values ...*cladminmodel.SysUserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (s sysUserRoleDo) First() (*cladminmodel.SysUserRole, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*cladminmodel.SysUserRole), nil
	}
}

func (s sysUserRoleDo) Take() (*cladminmodel.SysUserRole, error) {
...
func (s sysUserRoleDo) Last() (*cladminmodel.SysUserRole, error) {
...
func (s sysUserRoleDo) Find() ([]*cladminmodel.SysUserRole, error) {
	result, err := s.DO.Find()
	return result.([]*cladminmodel.SysUserRole), err
}

func (s sysUserRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*cladminmodel.SysUserRole, err error) {
	buf := make([]*cladminmodel.SysUserRole, 0, batchSize)
...
func (s sysUserRoleDo) FindInBatches(result *[]*cladminmodel.SysUserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s sysUserRoleDo) FirstOrInit() (*cladminmodel.SysUserRole, error) {
...
func (s sysUserRoleDo) FirstOrCreate() (*cladminmodel.SysUserRole, error) {
...
func (s sysUserRoleDo) FindByPage(offset int, limit int) (result []*cladminmodel.SysUserRole, count int64, err error) {
...
func (s sysUserRoleDo) Delete(models ...*cladminmodel.SysUserRole) (result gen.ResultInfo, err error) {
