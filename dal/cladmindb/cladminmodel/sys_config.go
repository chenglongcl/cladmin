...
type SysConfig struct {
	...
	ParamValue string         `gorm:"column:param_value;type:text;not null" json:"paramValue"`        // value
	Type       int32          `gorm:"column:type;type:tinyint(4);not null;default:1" json:"type"`     // 1字符串值类型 2字符串JSON类型
	Status     int32          `gorm:"column:status;type:tinyint(4);not null;default:1" json:"status"` // 状态   0：隐藏   1：显示
